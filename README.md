...
| Folder | Package |
| --- | --- |
| `UnitTests/` `IntegrationTests/` `PlaywrightTests/` | [TUnit](https://tunit.dev) |
| `XUnit/` | [xUnit v2](https://xunit.net) |
| `XUnitV3/` | [xUnit v3](https://xunit.net) |
| `NUnit/` | [NUnit 4](https://docs.nunit.org) |
| `MSTest/` | [MSTest 4](https://learn.microsoft.com/dotnet/core/testing/unit-testing-mstest-intro) |
| `BUnit/` | [bUnit](https://bunit.dev) |
| `AdvancedPatterns/` | xUnit v3 + ASP.NET `TestServer` |
